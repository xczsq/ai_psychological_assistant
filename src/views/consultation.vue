<template>
    ...
    <div class="chat-main">
             ...
             <div class="message-item ai-message"v-if="messages.length === 0">
                  ...
                  <div class="message-content">
                      <div class="message-bubble">
                          <p>您好！我是小暖，您的AI心理健康助手，很高兴陪伴您，为您提供温暖的心理支持。请告诉我，今天感觉怎么样？有什么想分享的吗？</p>
                      </div>
         ...
         <div class="chat-input">
             ...
             <el-button :disabled="!userMessage.trim() || userMessage.length>500" class="send-btn" @click="sendMessage" style="color: #fff;">
                 <el-icon>
                      <Promotion />
                 </el-icon>
             </el-button>
...
const sendMessage=()=>{
    ...
    //如果没有或是临时对话，就需要创建新的会话
    if(currentSession.value && currentSession.value.status ==='TEMP'){
        startNewSession(message)
    } else if(currentSession.value && currentSession.value.sessionId){
        //已有会话，直接流式对话
...
const startNewSession = (message)=>{
    ...
    if(currentSession.value.sessionTitle==='新对话'){
        sessionParams.sessionTitle = `AI心理健康助手-${new Date().toLocaleString()}`
    }else{
        //如果是历史会话记录
